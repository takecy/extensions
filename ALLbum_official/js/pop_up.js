$(function() {
    ...
    // face info GET
    var getFaceAlbum = function(apiUrl, type, offset, callback) {

        var faceAlbums = new Array();

        $.ajax({
            type : "GET",
            url : apiUrl + "?dataType=" + type + "&offset=" + offset,
    ...
    var setAlbumPopular = function(faceAlbums){
    ...
    var setAlbumRecent = function(faceAlbums){
        console.log(faceAlbums);

        var $populars = $("#recents");
        var $ul = $("<ul>").addClass("thumbnails");
    ...
    //execute
    for (i = 0; i < 5; i++){
        getFaceAlbum(apiUrl, "popular", i, setAlbumPopular);
        getFaceAlbum(apiUrl, "recent", i, setAlbumRecent);
    }
